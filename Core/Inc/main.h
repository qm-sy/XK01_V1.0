...
#define AC_OUT1_Pin GPIO_PIN_3
#define AC_OUT1_GPIO_Port GPIOB
#define AC_OUT2_Pin GPIO_PIN_4
#define AC_OUT2_GPIO_Port GPIOB
#define AC_OUT3_Pin GPIO_PIN_5
#define AC_OUT3_GPIO_Port GPIOB
#define AC_OUT4_Pin GPIO_PIN_6
#define AC_OUT4_GPIO_Port GPIOB
